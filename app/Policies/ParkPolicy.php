...
class ParkPolicy
{
    ...
    {
        return $user->can('delete_any_park');
    }
     ...
     */
    public function replicate(User $user, Park $park): bool
    {
