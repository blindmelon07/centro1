...
class HospitalPolicy
{
    ...
    {
        return $user->can('view_any_hospital');
    }
    ...
    {
        return $user->can('create_hospital');
    }
    ...
    {
        return $user->can('update_hospital');
    }
    ...
    {
        return $user->can('delete_hospital');
    }
    ...
    {
        return $user->can('delete_any_hospital');
    }
     ...
     */
    public function replicate(User $user, Hospital $hospital): bool
    {
